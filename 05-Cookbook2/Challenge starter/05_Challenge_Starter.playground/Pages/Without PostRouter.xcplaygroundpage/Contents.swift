...
/* Look at the finished challenge playground. */
//: ## URLSession Cookbook 2 Challenge
//: ### PUT to json-server
//: This page shows the standard way to create a PUT request. Open __Sources/PostRouter.swift__ and follow the TODO instructions to complete the `PostRouter` enum. Then go to the next playground page to use it.
//:
